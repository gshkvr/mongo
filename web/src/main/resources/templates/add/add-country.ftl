...
<head>
    <meta charset="utf-8"/>
    <title><@spring.message code="title.add-country"/></title>
            ...
            <div class="main-content">
                <div class="row">
                    <div class="panel text-center">
                        <form action="/create-country" method="post">
                            <h1 class="section-title"><@spring.message code="title.add-country"/></h1>
                            <div>

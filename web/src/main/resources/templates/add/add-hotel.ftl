...
<head>
    <meta charset="utf-8"/>
    <title><@spring.message code="title.add-hotel"/></title>
                ...
                <div class="row">
                    <div class="panel text-center">
                        <form action="/create-hotel" method="post">
                            <h1 class="section-title"><@spring.message code="title.add-hotel"/></h1>
                            <div>
                                ...
                                <input type="text" id="name" name="name" placeholder="name" class="uui-form-element"
                                       pattern=".{3,40}" required title="3 to 40 characters"/>
                            </div>
                            <br>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" id="website" name="website" placeholder="website"
                                       class="uui-form-element" pattern=".{3,40}" required title="3 to 40 characters"/>
                            </div>
                            <br>
